    ...
    <aside className="w-80 h-full bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white flex-shrink-0 p-8 shadow-2xl backdrop-blur-sm">
      ...
      <nav className="flex flex-col gap-3">
        <div className="relative group">
          <div
            className={`flex items-center gap-4 px-5 py-4 w-full rounded-xl transition-all duration-300 ${
          ...
          <div className="absolute left-0 right-0 mt-2 bg-gradient-to-br from-gray-900/95 to-gray-800/95 rounded-2xl shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 backdrop-blur-md border border-gray-700/30">
